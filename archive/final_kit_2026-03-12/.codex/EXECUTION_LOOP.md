...
6. update docs/memory if system understanding changed
...
Call a specialist role when relevant:
- architecture changes or cross-module design -> architecture specialist
- auth, secrets, permissions, input trust boundaries -> security specialist
- performance regressions or hotspots -> performance specialist
- difficult defect isolation -> bug hunter
- weak coverage or missing regression tests -> test generator
- operator / API / migration docs gaps -> documentation steward
- duplication cleanup after stabilization -> refactor steward
